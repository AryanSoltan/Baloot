...
public class CommentController {
    ...
    @RequestMapping(value="/commodities/{id}/{userId}/comment",method = RequestMethod.POST)
    public Response getCommodity(@RequestBody String rateInfo ,@PathVariable(value="id") String commodityID,@PathVariable(value="userId") String userID ){
        try{
